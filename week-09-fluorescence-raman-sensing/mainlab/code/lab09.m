...
mainlab_dir = fileparts(script_dir);
r6g_dir = fullfile(mainlab_dir, 'data', 'lab9_R6G');
fluorescence_dir = fullfile(mainlab_dir, 'data', 'lab9_fluorescence', 'Group7');
...
ch1 = readmatrix(fullfile(r6g_dir, 'Tue_Group7_ch1_Test.csv'));
ch1(end, :) = [];
ch1(1, :) = [];
...
ch2 = readmatrix(fullfile(r6g_dir, 'Tue_Group7_ch2_Test.csv'));
ch2(end, :) = [];
ch2(1, :) = [];
...
ch3 = readmatrix(fullfile(r6g_dir, 'Tue_Group7_ch3_Test.csv'));
ch3(end, :) = [];
ch3(1, :) = [];
...
ch4 = readmatrix(fullfile(r6g_dir, 'Tue_Group7_ch4_Test.csv'));
ch4(end, :) = [];
ch4(1, :) = [];
...
ch5 = readmatrix(fullfile(r6g_dir, 'Tue_Group7_ch5_Test.csv'));
ch5(end, :) = [];
ch5(1, :) = [];
...
ch_f = zeros(5,1);
for i = 1:5
    filename = fullfile(fluorescence_dir, sprintf('Ch%d.jpg', i));
    rgb = imread(filename);
    gray = rgb2gray(rgb);
