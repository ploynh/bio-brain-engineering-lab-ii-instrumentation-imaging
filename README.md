...
This course block covers biomedical instrumentation, circuit construction, data acquisition, imaging, spectroscopy, and microfluidic analysis.
...
| 02 | `week-02-operational-amplifier-circuits` | Operational amplifier circuits | CSV measurements and op-amp circuit analysis. |
| 03 | `week-03-bioamplifier-filter-design` | Bio-amplifier filter design | MATLAB calculations for active filter behavior. |
| 04 | `week-04-daq-labview-programming` | DAQ and LabVIEW | MATLAB prelab script, LabVIEW DAQ exports, and waveform measurement data. |
| 05 | `week-05-cardiovascular-monitoring` | Cardiovascular monitoring | MATLAB prelab code and LabVIEW VI for ECG/PPG monitoring, with personal waveform outputs excluded. |
| 06 | `week-06-biomedical-imaging-acquisition` | CT and MRI acquisition/reconstruction | MATLAB projection/back-projection, FFT k-space work, and SENSE reconstruction. |
